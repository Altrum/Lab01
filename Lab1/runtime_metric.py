class RuntimeMetric:
    """
    Metrics class this class is used to check the amount of time a function takes in order
    to execute. this class was provided by Johns Hopkins Data Structures class.
    """
